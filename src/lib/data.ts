...
export interface BlogPost {
  ...
  forfatterBg: string;
  forfatterPortrait?: string; // Unsplash CDN URL — square headshot, ~200px
  dato: string;
...
/* ─── Specialist portraits ───
   Six unique authors across the BLOG_POSTS array. We map name → portrait URL
   once here so every post by the same person uses the same face. Sized at
   200px since the AuthorChip renders at ~28-40px. */
const SPECIALIST_PORTRAIT: Record<string, string> = {
  "Morten Bach":          UNSPLASH("1500648767791-00dcc994a43e", 200), // mid-30s man, byg / Specialist · Byg
  "Marie Lindgren":       UNSPLASH("1494790108377-be9c29b29330", 200), // 30s woman, marketing / Sikring
  "Jens Pedersen":        UNSPLASH("1472099645785-5658abf4ff4e", 200), // 40s man, senior specialist
  "Peter Bak Torjusen":   UNSPLASH("1560250097-0b93528c311a", 200),    // 40-50s man, executive director
  "Tina Holm":            UNSPLASH("1573497019940-1c28c88b4f3e", 200), // 30-40s woman, træningschef
  "Christian Funch":      UNSPLASH("1507003211169-0a1dd7228f2d", 200), // 30s-40s man, technical specialist
};
